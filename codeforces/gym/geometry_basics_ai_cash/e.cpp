...
int main(){
    ...
    Point<double> directionVector = bisector(X[1], X[2]);
    double a = directionVector.y;
    double b = -directionVector.x;
    double c = (X[0].y * directionVector.x) - (X[0].x * directionVector.y);
